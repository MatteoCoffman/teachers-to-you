      ...
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        <div className="prose prose-neutral max-w-none space-y-6 text-muted-foreground">
          ...
          <p>
            ...
            James, and Mozworth. Whether you are picking up guitar for the first
            time or deepening your bass technique, we meet you where you are.
          </p>
          <p>
            Lessons are in-person only at launch. Choose lessons at your location
            or at your teacher&apos;s — we keep scheduling simple with online
            booking and optional 4-week packages.
          </p>
        </div>
      </section>
